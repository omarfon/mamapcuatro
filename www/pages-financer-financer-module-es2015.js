...
let FinancerPage = class FinancerPage {
    constructor(routes, route, appointmentSrv, financerSrv, alertCtrl, loadingCtrl, financerdatSrv, appointmentProvider, popover) {
        this.routes = routes;
        this.route = route;
    ...
    pagePaquete() {
        ...
        this.appointmentSrv.createAppointment(subida, provisionId).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    next() {
        ...
        this.appointmentProvider.createAppointment(this.subida, provisionId).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log('data devuelta:', data);
            if (data.ok == false) {
                const alert = yield this.alertCtrl.create({
                    header: "Problema de reserva",
...
let DataFinancerService = class DataFinancerService {
    constructor(dataSertvice) {
...
DataFinancerService.ctorParameters = () => [
...
let FinancerService = class FinancerService {
    ...
    getFinancers() {
        ...
        return this.http.get(this.apiUrl + 'ebooking/planes-paciente', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => {
            return data;
        }) /* .catch(e =>{
    ...
    getPrice(servicio_id, prestacion_id, producto_id, medico_id, proposed_date) {
        ...
        const authorization = localStorage.getItem('authorization');
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        return this.http.get(this.apiUrl + `ebooking/citas/precio-prestacion?servicio_id=${servicio_id}&prestacion_id=${prestacion_id}&producto_id=${producto_id}&medico_id=${medico_id}&fecha=${proposed_date}`, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => {
            return data;
        }) /* .catch(e =>{
          return Observable.of(e)
        }); */);
    ...
    getPlanesPaciente(centerId, servicio_id, prestacion_id, medico_id, proposed_date) {
        const authorization = localStorage.getItem('authorization');
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        return this.http.get(this.apiUrl + `ebooking/planes-paciente-precio-prestacion?center_id=${centerId}&servicio_id=${servicio_id}&prestacion_id=${prestacion_id}&medico_id=${medico_id}&fecha=${proposed_date}`, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => {
            return data;
        }) /* .catch(e =>{
          return Observable.of(e)
        }); */);
...
//# sourceMappingURL=pages-financer-financer-module-es2015.js.map