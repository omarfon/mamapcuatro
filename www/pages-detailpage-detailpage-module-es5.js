...
var DetailpagePageModule = /** @class */ (function () {
    function DetailpagePageModule() {
    }
...
var DetailpagePage = /** @class */ (function () {
    function DetailpagePage(alertCtrl, router, appointmentProvider, routes, navCtrl) {
    ...
    DetailpagePage.prototype.ngOnInit = function () {
    ...
    DetailpagePage.prototype.desactivateTask = function (date) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        _this.appointmentProvider.destroyAppointment(_this.date).subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            var alert;
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
    ...
    DetailpagePage.prototype.dismiss = function () {
        this.navCtrl.back();
    };
    DetailpagePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-detailpage-detailpage-module-es5.js.map