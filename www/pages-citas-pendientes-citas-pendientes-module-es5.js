...
var CitasPendientesPageModule = /** @class */ (function () {
    function CitasPendientesPageModule() {
    }
    ...
    return CitasPendientesPageModule;
}());
...
var CitasPendientesPage = /** @class */ (function () {
    function CitasPendientesPage(appointmetSrv, routes, nav) {
    ...
    CitasPendientesPage.prototype.ngOnInit = function () {
        var _this = this;
        /* console.log('citas-pendientes page'); */
        this.appointmetSrv.getAppointmentsPeruser().subscribe(function (data) {
            return _this.dates = data;
        });
    };
    CitasPendientesPage.prototype.goToDetailDate = function (date) {
        var datosObj = JSON.stringify(date);
        /*  console.log('data armada', datosObj); */
        this.nav.navigateRoot(['detailpage', datosObj]);
    };
    CitasPendientesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-citas-pendientes-citas-pendientes-module-es5.js.map