...
const API_ENDPOINT = window['aviva'].baseUrl + '/api';
const IMAGESDOCTORS = window['aviva'].baseUrl + '/img/professionals/';
...
let ResumenPageModule = class ResumenPageModule {
};
...
let ResumenPage = class ResumenPage {
    constructor(loadCtrl, router, routes, appointmentProvider, alertCtrl, culqiPrv) {
    ...
    culqi() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (window['Culqi'].token) {
                ...
                this.payCulqiCharges = true;
                const self = this;
                this.culqiPrv.charges(data).subscribe((vuelta) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    openCulqi() {
        ...
        if (this.currentAppointment) {
            ...
            window['Culqi'].open();
            const i = setInterval(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    gotosave() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.appointmentProvider.createAppointment(this.subida, providerId).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
//# sourceMappingURL=pages-resumen-resumen-module-es2015.js.map