...
var HomePage = /** @class */ (function () {
    function HomePage(router, notasServ, datosPvr, popover, fcm, estado, alert, modalCtrl, registerFcm, chat) {
        this.router = router;
    ...
    HomePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.estado.actualMomento().subscribe(function (data) {
                    _this.actualMomento = data;
                    console.log(data);
                    _this.estadoActual();
                });
                this.fcm.getToken().then(function (data) {
                    ...
                    if (token)
                        ...
                        _this.chat.registerToken(token);
                });
                ...
                cargaPublic = localStorage.getItem('role');
                /* const start = localStorage.getItem('startPregnancy') */
                if (cargaPublic == 'user') {
                    this.datosPvr.getStartPregnacy().subscribe(function (data) {
                        _this.params = data;
                    });
                    this.calculoFecha();
                }
    ...
    HomePage.prototype.estadoActual = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.actualMomento && this.actualMomento.status !== 'active')) return [3 /*break*/, 3];
    ...
    HomePage.prototype.calculoFecha = function () {
        var _this = this;
        ...
        var totalDays = this.today.diff(this.fecha, 'days');
    ...
    HomePage.prototype.goToEvolution = function () {
    ...
    HomePage.prototype.openFilters = function (ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var popover;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var RegisterFcmService = /** @class */ (function () {
    function RegisterFcmService(http) {
        this.http = http;
    ...
    RegisterFcmService.prototype.registerToken = function (token) {
        var authorization = localStorage.getItem('authorization');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Authorization': authorization });
        var params = { token: token };
        return this.http.post(this.apiUrl, params, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            return data;
        }));
    };
    RegisterFcmService.ctorParameters = function () { return [
