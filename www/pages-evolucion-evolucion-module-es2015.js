...
let EvolucionPageModule = class EvolucionPageModule {
};
...
let EvolucionPage = class EvolucionPage {
    constructor(evoSrv, routes) {
        this.evoSrv = evoSrv;
        this.routes = routes;
    }
    ngOnInit() {
...
let EvolucionService = class EvolucionService {
    ...
    getSemanas() {
        return this.http.get(this.apiUrl + `?_sort=semana:asc`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((resp) => {
            return resp;
        }));
    }
};
EvolucionService.ctorParameters = () => [
...
//# sourceMappingURL=pages-evolucion-evolucion-module-es2015.js.map