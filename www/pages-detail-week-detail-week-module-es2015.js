...
let DetailWeekPageModule = class DetailWeekPageModule {
};
...
let DetailWeekPage = class DetailWeekPage {
    constructor(routes, route, notaSrv) {
        this.routes = routes;
        this.route = route;
...
//# sourceMappingURL=pages-detail-week-detail-week-module-es2015.js.map