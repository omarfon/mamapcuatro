...
let DetailcontrolPageModule = class DetailcontrolPageModule {
};
...
let DetailcontrolPage = class DetailcontrolPage {
    constructor(recipeSrv, route, routes) {
    ...
    ngOnInit() {
        ...
        this.recipeSrv.getRecipes(id).subscribe((data) => {
            this.recipes = data;
            ...
            for (let i = 0; i < this.recipes.length; i++) {
                let dias = moment__WEBPACK_IMPORTED_MODULE_4__(this.recipes.fin_prescripcion).diff(this.recipes.inicio_prescripcion, 'days');
...
DetailcontrolPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-detailcontrol-detailcontrol-module-es2015.js.map