...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, routes, menu) {
    ...
    AppComponent.prototype.goToDetailDatos = function () {
...
var CalcComponent = /** @class */ (function () {
    function CalcComponent(router, popoverCtrl) {
        this.router = router;
        this.popoverCtrl = popoverCtrl;
    }
    CalcComponent.prototype.ngOnInit = function () { };
    CalcComponent.prototype.saveDate = function (nombre, fechaManual) {
    ...
    CalcComponent.ctorParameters = function () { return [
...
var FechaPregnancyComponent = /** @class */ (function () {
    function FechaPregnancyComponent(router, popoverCtrl) {
        this.router = router;
        this.popoverCtrl = popoverCtrl;
    }
    FechaPregnancyComponent.prototype.ngOnInit = function () { };
    FechaPregnancyComponent.prototype.saveDate = function (nombre, fechaManual) {
        localStorage.setItem('patientName', nombre.value);
        localStorage.setItem('startPregnancy', fechaManual.value);
        this.popoverCtrl.dismiss();
        this.router.navigate(['tabs']);
    ...
    FechaPregnancyComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["PopoverController"] }
    ]; };
    ...
    return FechaPregnancyComponent;
}());
...
var FiterComponent = /** @class */ (function () {
    function FiterComponent(routes, popover) {
        this.routes = routes;
        this.popover = popover;
    }
    FiterComponent.prototype.ngOnInit = function () { };
    FiterComponent.prototype.goToHomePastilla = function () {
        console.log('pastilla');
        this.popover.dismiss();
    };
    FiterComponent.prototype.goToHomeComparativa = function () {
        console.log('comparativa');
        this.popover.dismiss();
    };
    FiterComponent.prototype.goToHomeDesarrollo = function () {
        console.log('evobebe');
        this.popover.dismiss();
    };
    FiterComponent.prototype.goToHomeCambios = function () {
        console.log('cambio');
        this.popover.dismiss();
    };
    FiterComponent.prototype.goToHomeNutricion = function () {
        console.log('nutricion');
        this.popover.dismiss();
    };
    FiterComponent.prototype.goToHomeSemana = function () {
        console.log('nota 3');
        this.popover.dismiss();
    };
    FiterComponent.prototype.selectedDay = function (dia) {
        console.log('selectedDay');
        this.popover.dismiss();
    };
    FiterComponent.prototype.getAll = function () {
        console.log('todo');
        this.popover.dismiss();
    };
    FiterComponent.ctorParameters = function () { return [
...
var InfonopagoComponent = /** @class */ (function () {
    function InfonopagoComponent(popover) {
        this.popover = popover;
    }
    InfonopagoComponent.prototype.ngOnInit = function () { };
    InfonopagoComponent.prototype.back = function () {
        this.popover.dismiss();
    };
    InfonopagoComponent.ctorParameters = function () { return [
...
var ModalCodeComponent = /** @class */ (function () {
    function ModalCodeComponent(crudSrv, alertCtrl, form, loadingCtrl, events, routes) {
    ...
    ModalCodeComponent.prototype.ngOnInit = function () {
        var _this = this;
        var email = this.data.email;
        this.crudSrv.validateEmail(email).subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    ...
    ModalCodeComponent.prototype.saveData = function (primero, segundo, tercero, cuarto) {
        var _this = this;
        console.log(primero);
        var uno = primero;
        var dos = segundo;
        ...
        this.crudSrv.createNewUser(this.datos).subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            _this.message = "El código no es valido";
        });
    };
    ModalCodeComponent.prototype.sendCode = function () {
        var _this = this;
    ...
    ModalCodeComponent.ctorParameters = function () { return [
...
var CrudService = /** @class */ (function () {
    ...
    CrudService.prototype.createNewUser = function (datos) {
        ...
        return this.http.post(this.apiCreate, params, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
            return resp;
        }));
    };
    CrudService.prototype.validateEmail = function (email) {
        var authorization = localStorage.getItem('authorization');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        var params = { email: email };
        return this.http.post(this.apiValidate, params, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
            return resp;
        }));
    };
...
var API_ENDPOINT = "https://dappapache02.eastus.cloudapp.azure.com/middleware2-copy/api/v2/";
var API_NOTAS = "https://dappapache02.eastus.cloudapp.azure.com/middleware2-copy/api/v2/mama/notas";
var firebaseConfig = {
