...
var CitasPage = /** @class */ (function () {
    function CitasPage(routes, route, citasSrv, loadingCtrl, nav, finanSrv) {
        this.routes = routes;
        this.route = route;
    ...
    CitasPage.prototype.ionViewWillEnter = function () {
        this.getDoctors();
    };
    CitasPage.prototype.getDoctors = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.citasSrv.getServicios().subscribe(function (servicios) {
                    _this.servicios = servicios;
                });
                /* loading.dismiss(); */
                this.citasSrv.getDoctorsPerId(this.id).subscribe(function (doctors) {
                    _this.disponibles = false;
                    if (doctors.length == 0) {
                        _this.disponibles = true;
                        return null;
                    }
                    console.log(doctors);
                    _this.doctors = doctors;
                    var _loop_1 = function (doctor) {
                        _this.citasSrv.getAvailablesPerDoctor(doctor.id, doctor.service.id, _this.fromDate, _this.toDate).subscribe(function (availables) {
                    ...
                    _this.doctorsF = _this.doctors;
                    console.log(_this.doctorsF);
    ...
    CitasPage.prototype.expandedItem = function (doctor, available) {
        var _this = this;
        if (!this.hora) {
            console.log('doctor y available:', doctor, available);
            this.selectedDay = available;
            var id = doctor.id;
            var serviceId = doctor.service.id;
            var fromDate = this.selectedDay.date;
            var toDate = this.selectedDay.date;
            this.citasSrv.getAvailablesPerDoctor(id, serviceId, fromDate, toDate).subscribe(function (hoy) {
                console.log('hoy', hoy);
    ...
    CitasPage.prototype.goToFinancer = function (doctor, hora) {
    ...
    CitasPage.ctorParameters = function () { return [
...
var CitasService = /** @class */ (function () {
    ...
    CitasService.prototype.getServicios = function () {
        var authorization = localStorage.getItem('authorization');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        var center_id = 1;
        return this.http.get(this.apiUrl + ("ebooking/fmt-centers/" + center_id + "/services"), { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
            return resp;
        }) /* .catch(e =>{
          return Observable.of(e)
        }) */);
    };
    CitasService.prototype.getDoctorsPerId = function (id) {
        var _this = this;
        var authorization = localStorage.getItem('authorization');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        var center_id = 1;
        return this.http.get(this.apiUrl + ("ebooking/fmt-centers/" + center_id + "/services/" + id + "/professionals"), { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
            _this.doctores = resp.centers[0].services[0].professionals;
    ...
    CitasService.prototype.getAvailablesPerDoctor = function (id, serviceId, fromDate, toDate) {
        var authorization = localStorage.getItem('authorization');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Authorization": authorization });
        var center_id = 1;
        return this.http.get(this.apiUrl + ("ebooking/fmt-centers/" + center_id + "/services/" + serviceId + "/professionals/" + id + "/availables?from_date=" + fromDate + "&to_date=" + toDate), { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
...
//# sourceMappingURL=pages-citas-citas-module-es5.js.map