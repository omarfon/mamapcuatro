...
var RecoverycodePageModule = /** @class */ (function () {
    function RecoverycodePageModule() {
    }
...
var RecoverycodePage = /** @class */ (function () {
    function RecoverycodePage(usrSrv, form, alertCtrl, router, routes, events) {
        this.usrSrv = usrSrv;
        this.form = form;
    ...
    RecoverycodePage.prototype.ngOnInit = function () {
        var dataObj = this.router.snapshot.paramMap.get('dataObj');
    ...
    RecoverycodePage.prototype.saveData = function () {
        ...
        this.usrSrv.recoveryLogin(this.datos).subscribe(function (data) {
            _this.logeo = data;
    ...
    RecoverycodePage.prototype.goToLogin = function () {
        /* this.navCtrl.setRoot(LoginPage); */
        this.routes.navigate(['login']);
    };
    RecoverycodePage.prototype.sendCode = function () {
        console.log('enviar codigo');
    };
    RecoverycodePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-recoverycode-recoverycode-module-es5.js.map