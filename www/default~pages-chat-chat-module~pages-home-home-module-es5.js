(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-chat-chat-module~pages-home-home-module"],{
...
var ChatService = /** @class */ (function () {
    function ChatService(db, ad) {
        this.db = db;
        this.ad = ad;
    }
    ChatService.prototype.getChatRoom = function (uid) {
        console.log(uid);
        return this.db.collection('chatsRooms').doc(uid).valueChanges();
    };
    ChatService.prototype.sendMessageToFirebase = function (message, chat) {
    ...
    ChatService.prototype.registerForCustom = function () {
        var _this = this;
        var registrar = localStorage.getItem('uid');
        if (registrar) {
            ...
            return new Promise(function (resolve, reject) {
                _this.ad.auth.signInWithCustomToken(token_1).then(function (res) {
                    console.log(res);
                    localStorage.setItem('uid', res.user.uid);
                    if (localStorage.getItem('uid')) {
                        _this.uid = localStorage.getItem('uid');
                        _this.uidEnBase = _this.db.collection('chatsRooms').doc(_this.uid);
                        if (_this.uidEnBase == _this.uid) {
                            _this.id = localStorage.getItem('id');
                            _this.email = localStorage.getItem('email');
                            _this.db.collection('chatsRooms').doc(_this.uid).set({
                                id: _this.uid,
                        ...
                        return _this.db.collection('chatsRooms').doc(uid).valueChanges();
                    }
                }).catch(function (err) { return reject(err); });
            });
        }
    };
    ChatService.prototype.loginEmailUser = function (email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.ad.auth.signInWithEmailAndPassword(email, password)
                .then(function (userData) { return resolve(userData); }),
                function (err) { return (reject(err)); };
        });
    };
    ChatService.prototype.registerChatRoom = function () {
        /* this.db.collection('chatsRooms').add() */
    };
    ChatService.prototype.registerToken = function (token) {
...
//# sourceMappingURL=default~pages-chat-chat-module~pages-home-home-module-es5.js.map