...
let RegisterPage = class RegisterPage {
    constructor(fb, crudSrv, routes, dataSvr, alertCtrl, popoverCtrl) {
        this.fb = fb;
    ...
    seeConditions() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const terminos = yield this.alertCtrl.create({
    ...
    openPopover() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.crudSrv.validateEmail(email).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                /* console.log(res); */
...
let DataService = class DataService {
    ...
    getGenders() {
        ...
        return this.http.get(this.apiUrl + 'genders', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(data => {
            return data;
        }) /* .catch(e =>{
    ...
    getDocuments() {
        const authorization = localStorage.getItem('authorization');
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ "Authorization": authorization });
        return this.http.get(this.apiUrl + 'documenttypes', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(data => {
            return data;
        }) /* .catch(e =>{
          return Observable.of(e)
        }); */);
