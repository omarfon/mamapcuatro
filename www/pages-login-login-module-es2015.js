...
let LoginPage = class LoginPage {
    constructor(autho, userSrv, alertCtrl, router, events, datosSrv, popover) {
        this.autho = autho;
    ...
    doSignIn(email, password) {
        ...
        this.userSrv.doSignIn(email, password).subscribe((response) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.data = response;
            ...
            if (this.data.sex == 'HOMBRE') {
                ...
                this.datosSrv.getStartPregnacy().subscribe((data) => {
                    if (!data) {
...
let AuthoService = class AuthoService {
    constructor(http) {
        this.http = http;
    ...
    getKey() {
        return this.http.get(this.apiUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => {
            return data;
        }));
    }
};
AuthoService.ctorParameters = () => [
