...
let ControlesPageModule = class ControlesPageModule {
};
...
let ControlesPage = class ControlesPage {
    constructor(datosControl, routes) {
    ...
    ngOnInit() {
        ...
        let fechaFin = moment__WEBPACK_IMPORTED_MODULE_2__(localStorage.getItem('startPregnancy')).add(10, 'M').format('YYYY-MM-DD');
        this.fechaFinal = fechaFin;
        this.datosControl.getParams(this.fechaIni, this.fechaFinal).subscribe((data) => {
            if (!data) {
                this.message = true;
            }
            else {
...
//# sourceMappingURL=pages-controles-controles-module-es2015.js.map